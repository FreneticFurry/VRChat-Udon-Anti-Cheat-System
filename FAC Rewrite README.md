...
| Use Shader Block | this will determine if the anti cheat will use "ShaderBlock" <span style="color:#ff0000;">WARNING</span>: will disable Username and Chatbox, anything transparent will not render, change the render queue to fix though makes other shaders able to render aswell in avatars. | False
