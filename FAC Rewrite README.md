...
| Use Shader Block | this will determine if the anti cheat will use "ShaderBlock" $${\color{#ff0000}Warning}$$: will disable Username and Chatbox, anything transparent will not render, change the render queue to fix though makes other shaders able to render aswell in avatars. | False
